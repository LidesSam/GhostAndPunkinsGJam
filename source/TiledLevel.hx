...
class TiledLevel extends TiledMap
{
	...
	//inline static var c_PATH_LEVEL_TILESHEETS = "assets/data/Stages/";
	...
	public function new(tiledLevel:FlxTiledMapAsset, state:PlayState)
	{
		...
		for (layer in layers)
		{
			...
			{
				var tileset = tilesets["basic-tileset"];
	...
	function loadObject(state:PlayState, o:TiledObject, g:TiledObjectLayer, group:FlxGroup)
	{
		var x:Int = o.x;
		var y:Int = o.y;
		FlxG.log.add("loadObject:" + o.name+" o.type: " + o.type.toLowerCase() );
		...
		{
			case "playerstart":
				state.setPlayerPos(o.x + o.width / 2, o.y + o.height / 2);
			...
			case "exit":
				...
				//group.add(exit);
			case "item":
				var item:Item = new Item(o.x, o.y);
				state.items.add(item);
				
			case "genpoint":
				state.generator.addSpot(o.x, o.y, o.width, o.height);
		}
	}
